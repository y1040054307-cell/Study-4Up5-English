(() => {
  ...
  const AUDIO_PACK_CACHE = "sunny-audio-pack-v26";
  ...
  if("serviceWorker" in navigator) window.addEventListener("load",()=>navigator.serviceWorker.register("service-worker.js?v=26",{updateViaCache:"none"}).then(reg=>reg.update()).catch(()=>{}));
})();
