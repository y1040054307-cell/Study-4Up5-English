(() => {
  ...
  const AUDIO_PACK_CACHE = "sunny-audio-pack-v27";
  ...
  if("serviceWorker" in navigator) window.addEventListener("load",()=>navigator.serviceWorker.register("service-worker.js?v=27",{updateViaCache:"none"}).then(reg=>reg.update()).catch(()=>{}));
})();
