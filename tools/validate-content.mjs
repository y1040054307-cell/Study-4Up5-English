...
for(const file of ["curriculum.js","dictionary.js","growth.js","grammar.js","bridge-content.js"]){
...
console.log(`内容校验通过：${books.length}册、${units.length}单元、${topics.length}个语法主题。`);
